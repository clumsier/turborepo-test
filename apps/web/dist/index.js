...
nextApp.prepare().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        server = (0, http_1.createServer)(app).listen(port);
        // timeout on disconnecting requests
        server.setTimeout(10 * 1000);
        console.info("> Server listening at http://localhost:".concat(port, " as ").concat(dev ? 'development' : process.env.NODE_ENV));
        return [2 /*return*/];
    });
}); });
